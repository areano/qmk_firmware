...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_LGUI, KC_LALT, KC_LCTL, BL,      SPACE,   SPACE,   RAISE,   KC_LCTL, KC_LALT, KC_LGUI, XXXXXXX
),
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
...
[_NAV] = LAYOUT_planck_grid(
    KC_TILD, KC_INS,  XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
