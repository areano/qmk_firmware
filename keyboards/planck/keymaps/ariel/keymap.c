...
#define RS_TRNS RSFT(KC_TRNS)
#define LS_TRNS LSFT(KC_TRNS)
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LGUI, KC_LALT, KC_LCTL, LOWER,   KC_SPC,  KC_SPC,  RAISE,   LCTL_T(KC_LEFT), LALT_T(KC_DOWN), LGUI_T(KC_UP), KC_RGHT
),
